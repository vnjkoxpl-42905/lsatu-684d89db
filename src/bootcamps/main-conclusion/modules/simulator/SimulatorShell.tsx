  ...
  return (
    <article className="px-6 py-10 max-w-3xl mx-auto space-y-6">
      ...
      <ul className="grid gap-2 sm:grid-cols-2">
        <li>
          <Link to="/bootcamp/structure-v2/simulator/bank" className="block">
        ...
        <li>
          <Link to="/bootcamp/structure-v2/simulator/trap-master" className="block">
            <Card variant="surface" className="hover:border-[rgb(var(--accent)/0.30)] transition-colors">
        ...
        <li>
          <Link to="/bootcamp/structure-v2/simulator/hard-mode" className="block">
            <Card variant="surface" className="hover:border-[rgb(var(--accent)/0.30)] transition-colors">
