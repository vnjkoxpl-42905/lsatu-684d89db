  ...
  if (!data) {
    return (
      <div className="px-6 py-12 max-w-prose mx-auto">
        ...
        <Link to="/bootcamp/structure-v2/lessons" className="text-mc-accent font-mc-mono text-mono mt-4 inline-block">← Back to Lessons</Link>
      </div>
    );
  }
  ...
  return (
    <article className="px-6 py-10 desktop:px-12 desktop:py-14 max-w-[840px] mx-auto" data-lesson-id={data.id}>
      ...
      <div className="mt-10 flex flex-wrap items-center justify-between gap-3">
        ...
        <Link to="/bootcamp/structure-v2/lessons" className="font-mc-mono text-mono text-ink-soft hover:text-ink">
          ← Back to Lessons
        </Link>
      </div>
    </article>
