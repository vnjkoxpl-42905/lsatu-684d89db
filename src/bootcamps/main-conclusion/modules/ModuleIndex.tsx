...
const modules = [
  { id: 'M1', name: 'Lessons', to: '/lessons', desc: '12 voice-led lessons + capstone calibration. Voice register 2 (whimsical) for prose; register 1 (decisive) for callouts.' },
  { id: 'M2', name: 'Reference + Indicator Vault', to: '/reference', desc: 'Glanceable companion. The Indicator Vault, FABS, the 2-Part Conclusion Check. Always accessible.' },
  { id: 'M3', name: 'Drills', to: '/drills', desc: '9 drills, stratified by mechanic. Each drill is its own Stage-Gate.' },
  { id: 'M4', name: 'Question Simulator + Trap Master', to: '/simulator', desc: 'Real LSAT-format questions with full 5-choice answer set + 7-trait diagnostic. Unlocks after Drill 3.4.' },
  { id: 'M5', name: 'Reading Hard Sentences', to: '/hard-sentences', desc: 'Decompose monsters called cluster sentences.' },
  { id: 'M6', name: 'Diagnostics + AI Tutor + Progress', to: '/diagnostics', desc: 'Calibration after teaching, not gatekeeping before. Populates after Lesson 1.13 capstone.' },
];
